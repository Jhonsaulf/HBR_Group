...
namespace AppWeb.Controllers
{
    public class ViewUsersController : Controller
    {
        ...
        public List<ProductPojo> SearchItem(List<ProductPojo> products, string input) //Search item in list//
        {
            var productsearch = products.Where(elem => elem.Category == input).ToList();
